    ...
    for line in file:
        ...
        if s == "DATA":
            ...
            while i < 10:
                ...
                sendG.append(float(splitpline[1])*2)
                recG.append(float(splitpline[2])*2)
                cGap.append(float(splitpline[3])*2)
                total.append(float(splitpline[4])*2)
...
if __name__ == "__main__":
    ...
    s = open("estimationCBig/special_cart.txt", "w")
    s.close()
    readGaps()
    k = calcSpeed
    for i in sorted(datamap.keys()):
        k = calcSpeed
        f = open("estimationCBig/" + i + "_cart.txt", "w")
        WIDTH = int(i)
        ...
        while k >= 50000000:
            ...
            while j < 4000:
                ...
                f.write(str(t) + "\n\n")
                if special:
                    s = open("estimationCBig/special_cart.txt", "a")
                    s.write(str(info))
                    s.write(str(t))
                    s.close()
                j+=10
